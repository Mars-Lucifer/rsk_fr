...
const STEP = 0.112;
// Четыре места в ряду, то есть три ряда на двенадцать разделов. Шесть в ряд занимали
// 0.67 м — шире, чем остаётся справа от ноутбука в кадре разбора, и крайние карты
// вылезали за кромку. Четыре дают 0.45 м и умещаются целиком.
