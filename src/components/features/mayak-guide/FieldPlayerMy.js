...
const PHASES = [
    { id: 0, label: "Раскладка и выкладка", text: "Разделы колоды ложатся на карточки направлений «ЗВЕЗДЫ», и одновременно команда выкладывает девять жетонов такта рубашкой вверх. План зафиксирован." },
    { id: 1, label: "Разбор и выполнение", text: "На каждый выложенный жетон из его раздела уходит карта задания: участник забирает её, решает через МАЯК-ОКО и сдаёт инспектору соседней команды." },
    { id: 2, label: "Переворот", text: "Задание принято — жетон переворачивается цветной стороной вверх, на трек индекса встаёт звезда в это направление." },
    { id: 3, label: "Итог", text: "Четыре такта по девять задач: 36 жетонов и 36 звёзд. Такт не начинается, пока предыдущий не закрыт целиком." },
];
