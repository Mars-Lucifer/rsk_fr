...
export const DAY_TWO_TEMPLATE_CARDS = [
    ...
    },
    {
        ...
        "hint": null,
        "notes": "Роль в платформе выбирать не нужно. В день 2 работу принимает своя команда: деталь — партнёр по паре, узел — соседняя пара стола, сборку, приёмку и карту — любой другой человек стола.",
        "hexes": [],
        "figure": "узел 11 12",
        "tool": null,
        "file": ""
    },
    {
        ...
        "task": "Запомните шесть шагов: промпт, сова, нейросеть, «Завершить», окно сдачи, партнёр.",
        "submit": "Ничего. Нажмите «Завершить».",
        "done": "Вы знаете, что в окне сдачи можно написать текст, а файл — по желанию.",
        "hint": null,
        "notes": "Кнопка «Завершить» открывает окно сдачи: туда вставляют текст ответа или прикладывают файл (docx, pdf, png, jpg), потом «Отправить инспектору». Кнопка называется так с первого дня, но в день 2 заявка уходит партнёру по паре за вашим столом: он смотрит ответ по строке «готово, когда». Сова оценивает промпт. Истекло — значит принято. Если экран стал другим — откройте ссылку из мессенджера заново.",
        "hexes": [],
        "figure": "приёмка 6",
        "tool": null,
        "file": ""
    },
    {
        ...
        "notes": "Семь полей выше — для тех, кто успел раньше: нарисуйте первый экран нейросетью, картинка пригодится на питче. Три строки потом идут в поля «Аудитория» и «Контекст» каждого вашего промпта. Принимающему: принимай, если есть все три строки и они про одного пользователя.",
        "hexes": [],
        "figure": "точка",
        "tool": {
    ...
    },
    {
        ...
        "task": "Дайте партнёру по паре пройти семь шагов, молча.",
