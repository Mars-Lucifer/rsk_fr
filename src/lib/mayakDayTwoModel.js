...
export const DAY_TWO_TEMPLATE_CARDS = [
    {
        ...
        "mins": 5,
        "why": "Шестнадцать карточек за день: сначала целое, потом части, потом снова целое.",
    ...
    },
    {
        ...
        "title": "Как сдавать",
        "mins": 5,
        "why": "Каждая карточка сдаётся одинаково, семь шагов, всегда одни и те же.",
        "task": "Промпт → сова → нейросеть → «Завершить» → окно сдачи → инспектору.",
        "submit": "Ничего. Нажмите «Завершить».",
    ...
    },
    {
        ...
        "title": "Точка 0",
        "mins": 40,
        "why": "Стол договаривается, кому помогает и что изменится. Без этого детали не сойдутся.",
        "task": "Три строки: кому, какая боль, что изменится; картинка первого экрана.",
        "submit": "Три строки текстом в окно сдачи, картинку первого экрана — файлом png. Сдаёт тот, кто диктовал.",
        "done": "Любой за столом пересказывает три строки без бумажки. Эти три строки каждый вставляет в поля «Аудитория» и «Контекст» во всех своих промптах.",
        "hint": {
            "m": "нарисовать первый экран продукта",
            "a": "ваш пользователь",
            "ya": "дизайнер интерфейсов",
            "k": "простой, один экран, с логотипом",
            "o1": "три элемента, не больше",
            "k2": "покажем на питче через 20 минут",
            "o2": "картинка png"
        },
        "notes": "Инспектору: принимай, если есть все три строки и они про одного пользователя.",
        "hexes": [],
        "figure": "точка",
        "tool": {
    ...
    },
    {
        ...
        "task": "Три минуты: продукт, пользователь, первый экран.",
        "submit": "Файла нет. «Завершить» → в окне напишите «сделано» → «Отправить инспектору».",
    ...
    },
    {
        ...
        "mins": 80,
        "why": "Пользователь должен понять продукт без обучения.",
        "task": "Пять вопросов пользователя и пять ответов, по строке.",
    ...
    },
    {
        ...
        "mins": 80,
        "why": "Продукт живёт среди других людей и систем.",
        "task": "Три партнёра снаружи: что даёт, что получает.",
    ...
    },
    {
        ...
        "mins": 80,
        "why": "Продукт считает, а не только показывает.",
        "task": "Таблица данных из шести полей и четыре числа.",
    ...
    },
    {
        ...
        "mins": 80,
        "why": "Что продукт делает сам, без человека.",
        "task": "Три шага, которые продукт делает сам: когда, что, кому.",
    ...
    },
    {
        ...
        "mins": 80,
        "why": "Пользователь видит экраны, а не таблицы.",
        "task": "Три экрана продукта: что на каждом, одна кнопка.",
    ...
    },
    {
        ...
        "mins": 80,
        "why": "Каждый видит только своё.",
        "task": "Таблица: роль, что видит, что не видит.",
    ...
    },
    {
        ...
        "task": "Один файл: путь пользователя от входа до результата.",
        "submit": "uzel_11_12.docx, сдаёт 11",
    ...
    },
    {
        ...
        "task": "Один файл: таблица данных и три автоматических шага.",
        "submit": "uzel_13_14.docx, сдаёт 13",
    ...
    },
    {
        ...
        "task": "Три экрана с отметкой, какой роли что видно.",
        "submit": "uzel_15_16.pdf, сдаёт 15",
    ...
    },
    {
        ...
        "title": "Три узла",
        "mins": 30,
        "why": "Стол видит продукт целиком до сборки.",
        "task": "Три минуты: три узла, по минуте на пару.",
        "submit": "Файла нет. «Завершить» → в окне напишите «сделано» → «Отправить инспектору».",
    ...
    },
    {
        ...
        "title": "Изделие",
        "mins": 90,
        "why": "Три узла становятся одним продуктом с адресом.",
        "task": "Сборщик отдаёт три узла агенту по готовому промпту.",
        "submit": "Адрес продукта в папке стола.",
        "done": "Открывается с чужого телефона.",
        "hint": null,
        "notes": "Промпт сборщику готов, менять его не нужно. Остальные пятеро в это время правят тексты и картинки в узлах и проверяют ссылки: сборщик берёт правки в сборку.",
        "hexes": [],
        "figure": "изделие",
        "tool": {
            "name": "Промпт сборщику",
            "url": "http://ctr5.ru/1109/agent.html"
        },
        "file": ""
    },
    {
        ...
        "title": "Семь шагов",
        "mins": 30,
        "why": "Продукт проверяет посторонний, а не автор.",
        "task": "Человек соседнего стола проходит семь шагов, стол молчит.",
        "submit": "priemka.docx: скриншоты и где споткнулся.",
        "done": "Семь из семи или список починки.",
        "hint": null,
        "notes": "",
        "hexes": [],
        "figure": "приёмка",
        "tool": {
            "name": "Семь шагов",
            "url": "http://ctr5.ru/1109/priemka.html"
        },
        "file": ""
    },
    {
        ...
        "title": "Изделие",
        "mins": 30,
        "why": "Заказчик видит, что работает.",
        "task": "Пять минут: адрес, путь пользователя, что не успели.",
        "submit": "Файла нет. «Завершить» → в окне напишите «сделано» → «Отправить инспектору».",
    ...
    },
    {
        ...
        "title": "Шесть месяцев",
        "mins": 40,
        "why": "Продукт живёт дальше без нас: первые треки через 2, 4 и 7 недель.",
        "task": "Шесть строк: 2, 4, 7 недель, 3, 5, 6 месяцев.",
        "submit": "karta.docx. Шаблон — в поле «Файл» карточки.",
        "done": "В каждой строке фамилия и число, например: 30 подписчиков к декабрю.",
        "hint": {
