...
// usedCount по живым session-токенам доступа. Токены живут 24 часа: истёкшие
// отбрасываются при подсчёте, а свип их вообще удаляет. Значит через сутки
// расход исчезал и купленный лимит возвращался к исходному — заказчик платил за
// то, что и так восстанавливалось.
//
